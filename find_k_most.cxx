 ...
 * min heapify
 */
void minHeapify(MinHeap* minHeap, int idx)   //According to frequency to adjust
{
...
{
    if ((*root)->indexMinHeap != -1)   //This TrieNode already have a MinHeapNode point to it
    {
        ++( minHeap->array[(*root)->indexMinHeap].frequency);
        minHeapify(minHeap, (*root)->indexMinHeap);
    }
	//The TrieNode haven't a MinHeapNode point to it,and min->count < minHeap->capacity,so create 
	//a new MinHeapNode and make it point to TrieNode
...
{
    MinHeap* minHeap = createMinHeap(k);  //The MinHeap's capacity is k
    TrieNode* root = NULL;
